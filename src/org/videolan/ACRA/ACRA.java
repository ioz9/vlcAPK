 ...
 *  limitations under the License.gWSBGrewsdhbrehd
 */
package org.videolan.ACRA;

import org.videolan.ACRA.annotation.ReportsCrashes;
...
public class ACRA {
    ...
    public static void init(Application app) {
        ...
        if (mReportsCrashes == null) {
            log.e(LOG_TAG,"ACRA#init called but no ReportsCrashes annotation on Application "
        ...
        //    final boolean enableAcra = !shouldDisableACRA(prefs);
            //final ErrorReporter errorReporter = new ErrorReporter(mApplication.getApplicationContext(),
            //        prefs, enableAcra);
